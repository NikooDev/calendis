		...
		<section className="flex justify-center items-center h-dvh w-full bg-theme-700">
			<div className="relative px-4 w-full sm:max-w-[500px] z-30 pb-28 lg:pb-0">
				<div className="flex flex-col items-center justify-center relative">
					<SlideIn trigger="mount" delay={100} direction="bottom" className="flex flex-col lg:flex-row gap-2 lg:gap-8 mb-10">
						<div className="self-start flex m-auto">
							<Image src="/static/img/logo.webp" width={100} height={100} className="rounded-full box-shadow self-start select-none" alt="logo" priority aria-labelledby="logo"/>
						</div>
